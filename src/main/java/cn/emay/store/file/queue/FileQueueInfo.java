...
public class FileQueueInfo {
     ...
     * 文件大小
     */
    private static final int fileSize = 20;

    /**
     * 当前读取的文件编号
     */
    private int nowReadFileIndex;
    /**
     * 当前读取的数据游标
     */
    private int nowReadByteIndex;
    /**
     * 当前写入的文件编号
     */
    private int nowWriteFileIndex;
    /**
     * 当前写入的数据游标
     */
    private int nowWriteByteIndex;
    /**
     * 总数
     */
    private int count;
